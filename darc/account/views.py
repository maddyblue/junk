...
def pay(request):
	...
	return render(request, 'account/pay.html', {'p': p, 't': total, 'paypal': settings.PAYPAL_BUSINESS_ADDRESS, 'external': settings.EXTERNAL_ADDRESS, 'paypal_url': settings.PAYPAL_URL})

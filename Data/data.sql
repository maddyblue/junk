...
SELECT pg_catalog.setval('ability_ability_id_seq', 34, true);
...
SELECT pg_catalog.setval('group_def_group_def_id_seq', 2, true);
...
26	Ward*		12	0	0	0	Magic defense is raised by ability level/3	Gestures are made with the fingers, producing a feeble aura that deflects the brunt of magical blows.	
25	Hunch*		12	0	20	3	Defense is raised by ability level/3	The user pulls his or her head down and shoulders up, protecting precious brainmeats.	
27	Lend*		8	0	20	5	Target gains ability/1.5 to strength and ability/1.5 to magic\nUser loses ability/1.5 to strength and ability/1.5 to magic	The user focuses on an ally and lends his or her offensive power.	
28	Guard*		8	0	20	5	Target gains ability/1.5 to defense and ability/1.5 to magic defense\nUser loses ability/1.5 to defense and ability/1.5 to magic defense	The user places him or herself in danger's path to protect an ally.	
29	Dual Wield*		26	0	700	0	Passive ability, single level. Allows a dagger or a knuckle weapon to be wielded in the off hand.	The off hand is used as an offensive extension.	
32	Roulette*		23	0	700	0	One randomly chosen stat is reduced by 10 * ability level. That much is added to a second randomly chosen stat.	The forces of chance meddle with the body of a gambler to cripple him or her in one area but maximize focus on another.	
33	Spirit of Shadow*		15	0	100	75	Creates an ally that lasts for 15 * ability level minutes, with a level of ability level/5 (rounded down, minimum of 1, stats assumed a citizen of that level, no outside modifiers)\nAttacks foes	Calls a spirit from the air to aid in an attack.	
34	Spirit of Protection		15	0	0	0	Creates an ally that lasts for 15 * ability level minutes, with a level of ability level/5 (rounded down, minimum of 1, stats assumed a citizen of that level, no outside modifiers)\nUses White Magic abilities.	Calls a spirit from the earth that supports the well-being of the caller.	
31	Payoff*		23	0	300	50	case 1 (80%) : all stats are halved\ncase 2 (20%) : all stats get 10 * ability level	Calling upon the forces of chance, a gambler may commit to an all-or-nothing transformation.	
30	Shuffle*		23	0	500	0	Single level. Two randomly chosen stats are switched.	Shifty characters tend to have shifty means.\nCalling on the powers of chance, a gambler mixes his or her senses and abilities for a random result.	
\.
...
_SERVERTIME	0	eval	gmdate(TIMEFORMAT, TIME + TZOFFSET);				0	0	
...
IADS_SECTION_NAV	3	link	Upload Ad		'a=upload-ad'		1	0	
IADS_SECTION_NAV	4	link	View My Ads		'a=view-ads'		1	0	
\.

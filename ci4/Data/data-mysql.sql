truncate cor_area_monster;
truncate cor_area_town;
truncate cor_job_abilitytype;
truncate cor_job_equipmenttype;
truncate cor_job_joblv;
truncate cor_monster_drop;
truncate ability;
truncate equipment;
truncate monster;
truncate abilitytype;
truncate area;
truncate domain;
truncate equipmentclass;
...
ALTER TABLE abilitytype_abilitytype_id_seq AUTO_INCREMENT =30;
...
ALTER TABLE area_area_id_seq AUTO_INCREMENT =26;
...
ALTER TABLE domain_domain_id_seq AUTO_INCREMENT =6;
...
ALTER TABLE equipmentclass_equipmentclass_id_seq AUTO_INCREMENT =11;
...
ALTER TABLE equipmenttype_equipmenttype_id_seq AUTO_INCREMENT =18;
...
ALTER TABLE event_event_id_seq AUTO_INCREMENT =2;
...
ALTER TABLE group_def_group_def_id_seq AUTO_INCREMENT =1;
...
ALTER TABLE house_house_id_seq AUTO_INCREMENT =17;
...
ALTER TABLE item_item_id_seq AUTO_INCREMENT =2;
...
INSERT INTO item VALUES (1, 'Potion', 'Restore 100 HP to target.', true, false, 'echo ''<p/>'' . $src->name . '' uses a potion on '' . $dest->name . ''.'';
battleHeal($dest, 100);', '', 100, true);
INSERT INTO item VALUES (2, 'High Potion', 'Restores 250 HP to target.', true, false, 'echo ''<p/>'' . $src->name . '' uses a potion on '' . $dest->name . ''.'';
battleHeal($dest, 100);', '', 500, true);
...
ALTER TABLE job_job_id_seq AUTO_INCREMENT =29;
...
ALTER TABLE monstertype_monstertype_id_seq AUTO_INCREMENT =10;
...
ALTER TABLE town_town_id_seq AUTO_INCREMENT =17;
...
ALTER TABLE ability_ability_id_seq AUTO_INCREMENT =24;
...
INSERT INTO ability VALUES (12, 'Charge', '', 9, 0, 10, 10, 'A regular attack is increased by (lv + 1) * 1.2, but it takes lv turns to charge up. ', 'By slowly charging up your attack you may unleash your inner energy with the blow that will strike for greater damage.', '$smod = 1.2 * ($lv + 1);
...
ALTER TABLE equipment_equipment_id_seq AUTO_INCREMENT =139;
...
ALTER TABLE monster_monster_id_seq AUTO_INCREMENT =112;

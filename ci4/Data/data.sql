...
INSERT INTO ability VALUES (1,'Retreat',8,0,5,0,'Somehow agl is used to see if a player is able to run away from the battle. If the player can do it, the battle ends with some text saying \"You ran away.\" if not, then there is just some text saying \"You tried to retreat, but were not able to.\"','Discretion is the better part of valour and sometimes it is to your advantage to exercise this fact. Retreat allows you to withdraw from battle, if you can outrun your enemy, that is.','');
INSERT INTO ability VALUES (2,'Errantry',8,5,10,0,'STR is multiplied by 1.2. This skill doesn\'t work as often the higher your str gets. I want the point where it doesn\'t work anymore to be around 200. So basically, str gets divided by 200 and the lower the number the better the chances of it working, up until the quotient is 1.','Young Knights are often spirited on to greater feats of strength by their youthful exuberance, leading to a rush of adrenaline. While useful early on later it becomes useless as the knight relies more on finess than mindless attacking.','');
INSERT INTO ability VALUES (3,'Power Break',11,5,10,0,'This decreased the enemy\'s str by at most 25%. The monster\'s level is subtracted from your level, and the difference multiplied by a random number is how much it decreased. If the amount is negative, nothing happens.','To thwart the enemies attack is to leave them unable to oppose your victory over them, Power Break reduces your opponants strength leaving them less capable of inflicting damage.','');
INSERT INTO ability VALUES (4,'Magic Break',11,10,20,0,'Same idea as Power Break, but mag gets decreased by a maximum of 25%','A dwarf once said that the only good wizard was a dead wizard. Magic Break attacks the enemy in a way that inhibits their spell casting abilities, causing their spells to lose power and become less effective.','');
INSERT INTO ability VALUES (5,'Aura Of Fortitude',10,5,20,0,'Def will increase by 20 percent for 3 rounds.','An aura of fortitude surround thee, showing your faith and protecting you from the blows of you enemies.','');
INSERT INTO ability VALUES (6,'Mighty Aura',10,10,30,0,'Atk will increase by 20 percent for 3 rounds.','An aura infused with divine strength to aid the users blows in combat.','');
INSERT INTO ability VALUES (7,'Aura of Devoutness',10,15,50,0,'Mdef will increase by 20 percent for 3 rounds.','An aura of devout worship surrounds you, using the power of your devout faith to protect you from the magic of your enemies.','');
INSERT INTO ability VALUES (8,'Aura Of Vigilance',10,5,30,0,'Acc will increase by 20 percent for 3 rounds','With patience and vigilance you become empowered with a divine foresight, allowing you to strike with greater clarity.','');
INSERT INTO ability VALUES (9,'Aura Of Grace',10,10,50,0,'Agl will increase by 20 percent for 3 rounds.','Infused with an aura of divine grace you become swift and agile, easily avoiding the blows of your opponants.','');
INSERT INTO ability VALUES (10,'Spirit Break',11,5,20,0,'Same idea as Power Break, but mdef gets decreased by a maximum of 25%','By probing your targets defences you find a weak point in their mental armour, striking hard in order to leave them vunerable to magic attack.','');
INSERT INTO ability VALUES (11,'Armor Break',11,10,40,0,'Same idea as Power Break, but def gets decreased by a maximum of 25%','A heavy strike against your opponants defence breaks through their armour, leaving them weaker towards your strikes.','');
INSERT INTO ability VALUES (12,'Charge',9,5,10,0,'A regular attack is increased by ~1.5 but it takes 2 turns to charge up. ','By slowly charging up your attack you may unleash your inner energy with the blow that will strike for greater damage.','');
INSERT INTO ability VALUES (13,'Sureshot',9,10,20,0,'A regular attack with 1.5 times the accuracy','By focusing for a moment you can better percieve the path of your prey as you let fly with a deadly arrow.','');
INSERT INTO ability VALUES (14,'Eagle Eye',9,15,40,0,'ACC is multiplied by 1.2','Focusing the mind you become like an eagle, soaring majestically in your mind before seeing with flawless vision your prey.','');
INSERT INTO ability VALUES (15,'Cure',2,0,5,0,'Cast a weak healing magic spell','','');
INSERT INTO ability VALUES (16,'Fire',1,0,5,0,'Cast a weak fire elemental magic spell','','');
INSERT INTO ability VALUES (17,'Poisona',2,0,10,0,'Heals poison','','');
INSERT INTO ability VALUES (18,'Sleeple',2,5,10,0,'Attempts to put the enemy to sleep','','');
INSERT INTO ability VALUES (19,'Protect',2,10,20,0,'Increases Def by 1.5 for 3 rounds','','');
INSERT INTO ability VALUES (20,'Haste',2,15,30,0,'Increases AGL by 1.5 for 3 rounds','','');
INSERT INTO ability VALUES (21,'Blizzard',1,0,5,0,'Cast a weak ice elemental magic spell','','');
INSERT INTO ability VALUES (22,'Thunder',1,0,5,0,'Cast a weak lightning elemental magic spell','','');
INSERT INTO ability VALUES (23,'Force Missile',1,5,10,0,'Cast a weak magic spell with no elemental','','');
INSERT INTO ability VALUES (24,'Poison',1,10,10,0,'Inflicts poison status on the enemy','','');
...
INSERT INTO site VALUES ('PLAYER_SECTION_NAV',0,'link','Register new player','','\'a=newplayer\'','SECTION_PLAYER',1,0,'');

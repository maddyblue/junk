...
INSERT INTO site VALUES ('FORUM_SECTION_NAV',0,'eval','newthreadLink() . newreplyLink()','','','',1,0,'f and t are never specified together, hence this works well');
INSERT INTO site VALUES ('FORUM_SECTION_NAV',0,'link','View New Threads','','\'a=viewnew\'','SECTION_FORUM',1,0,'');
...
INSERT INTO site VALUES ('GAME_SECTION_NAV',10,'link','Manage Equipment','','\'a=equip\'','SECTION_GAME',1,0,'');

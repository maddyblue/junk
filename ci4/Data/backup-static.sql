...
INSERT INTO monster VALUES (2,'Gel','',10,3,4,2,6,2,2,3,2,20,7,0,0,10,0,10,0,0,0,1,'Gels are the smallest form of ooze. They are amaeoba like with a red nucleus surrounded by dull green jelly that shifts as they slowly move. Gels can be a little sickening but aren\'t very difficult to beat.');
...
INSERT INTO monster VALUES (6,'Grat','',20,9,6,2,5,2,3,5,3,16,11,0,0,10,0,10,0,0,0,7,'Grats a gangly limbed carniverous weeds that typically grow near the watering grounds for animals, seeking to draw one into it\'s trap like maw.');
INSERT INTO monster VALUES (7,'Green Drake','',40,3,8,4,8,4,7,3,4,25,20,10,0,10,0,0,0,0,0,4,'Green Drakes are the smallest and least powerful of the draconic family. Often haunting remote trails they often attack passing creatures for sport as much as for sustinance.');
INSERT INTO monster VALUES (8,'Rat','',40,3,6,2,4,4,5,5,4,16,11,0,0,10,0,0,0,0,10,3,'Small mucky rodents that swarm wherever there is food to be had, Rats are capable scavengers and are usually present in any dark place.');
